...
Алгоритм:
Для того чтобы найти подходящие курсы по цене, нам необходимо найти пересечения массивов с ценой курсв и желаемой ценой.
Для этого сравниваем окончаник цены курса с началом желаемой цены
